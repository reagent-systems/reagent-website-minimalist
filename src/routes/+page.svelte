...
<div class="min-h-screen flex flex-col justify-between bg-black text-white">
  ...
  <div class="w-full flex justify-center pb-24">
    <div class="flex space-x-16">
      <div class="text-lg" style="font-family: 'Courier New', Courier, monospace;">Pitch</div>
      <div class="text-lg" style="font-family: 'Courier New', Courier, monospace;">Discord</div>
      <div class="text-lg" style="font-family: 'Courier New', Courier, monospace;">Waitlist</div>
      <div class="text-lg" style="font-family: 'Courier New', Courier, monospace;">Social</div>
      <div class="text-lg" style="font-family: 'Courier New', Courier, monospace;">Team</div>
    </div>
  </div>
</div>
