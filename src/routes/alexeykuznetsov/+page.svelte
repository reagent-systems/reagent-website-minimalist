  ...
  <div class="profile-container fade-in" class:visible={fadeIn}>
    <div class="main-content">
      ...
      <div class="left-column">
        ...
        <div class="mb-6">
          <div>Age: 25</div>
          <div>Location: Lakeland, Florida</div>
          <div>Title: COO</div>
        </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <a href="https://www.github.com/alexeykuznetsov" class="text-lg underline-animate font-courier" style="color:inherit; text-decoration:none;">https://www.github.com/alexeykuznetsov</a>
