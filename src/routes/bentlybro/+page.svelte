  ...
  <div class="profile-container fade-in" class:visible={fadeIn}>
    <div class="main-content">
      ...
      <div class="left-column">
        ...
        <div class="mb-6">
          <div>Role: Self-Taught Developer & Systems Tinkerer</div>
          <div>Position: Community Lead - AutoGPT</div>
          <div>Languages: Python, JavaScript</div>
          <div>Focus: Cross-Device Systems, VR, EEG, Decentralized Tech</div>
        </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <a href="https://www.github.com/bentlybro/" class="text-lg underline-animate font-courier" style="color:inherit; text-decoration:none;">https://www.github.com/bentlybro/</a>
