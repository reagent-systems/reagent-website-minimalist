...
<div class="min-h-screen flex flex-col items-center justify-center bg-custom text-white">
  <div class="flex flex-col items-center fade-in flex-1 justify-center" class:visible={fadeIn} class:slide-up={sliding}>
    ...
    <div class="flex flex-row items-center justify-center space-x-16" style="margin-top:48px;">
      <a href="#" class="text-xl font-courier underline-animate" style="color:inherit; text-decoration:none;">Reka-200M</a>
      <a href="#" class="text-xl font-courier underline-animate" style="color:inherit; text-decoration:none;">Reka-1.5B</a>
      <a href="#" class="text-xl font-courier underline-animate" style="color:inherit; text-decoration:none;">Reka-7B</a>
    </div>
  </div>
</div> 